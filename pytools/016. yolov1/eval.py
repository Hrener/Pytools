...
from data.voc0712 import VOCAnnotationTransform, VOCDetection, BaseTransform, VOC_CLASSES
import sys
import os
import time
import argparse
...
def detect_net(save_folder, net, device, dataset, top_k, thresh=0.05):
...
if __name__ == '__main__':
    ...
    net = net.to(device)
    # evaluation
    detect_net(args.save_folder, net, device, dataset, args.top_k, thresh=args.confidence_threshold)